...
/* Exported types ------------------------------------------------------------*/
/**
 * @brief E-Scooter control System Level Configuration and Control (It's used in Debugging Purpose)
 *
 * Enumerates the variables and information that can be exchanged across the Motor Control Protocol (Extension)
 * It's run in debug mode. Users can input dummy data when using these features!
 */
typedef enum
{
...
#define MC_PROTOCOL_CODE_ES_CONTROL       0x0E
#define MC_PROTOCOL_TORQUE_RAMP_CONFIG    0x13
#define MC_PROTOCOL_TORQUE_DYNAMIC_CONFIG 0x14 /*Determines E-Scooter's driving mode + limitations*/
#define MC_PROTOCOL_CODE_SET_POSITION_CMD 0x12 /* Dynamic IQ or Current configuration triggered by throttle signals */
